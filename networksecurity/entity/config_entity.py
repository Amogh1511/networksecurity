...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir: str = os.path.join(training_pipeline_config.artifect_dir,
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config: TrainingPipelineConfig):
        self.model_trainer_dir: str = os.path.join(
            training_pipeline_config.artifect_dir,training_pipeline.MODEL_TRAINER_DIR_NAME
        )
        ...
        self.overfitting_underfitting_threshold = training_pipeline.MODEL_TRAINER_OF_UF_THRESHOLD
