...
from networksecurity.entity.artifect_entity import DataTransformationArtifact,ModelTrainerArtifact
from networksecurity.entity.config_entity import ModelTrainerConfig

from networksecurity.utils.ml_utils.model.estimator import Network
from networksecurity.utils.main_utils.utils import save_pickle_object,load_object
from networksecurity.utils.main_utils.utils import load_np_arry_data, evaluate_models
...
class ModelTrainer:
    ...
    def track_mlfolw(self,best_model,classificationmetric):
        try:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        try:
            ...
            #track experiments with ML Flow
            ...
            #track experiments with ML Flow
            self.track_mlfolw(best_model,classification_test_metric)
            #for to save model as pickle
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            train_arr=load_np_arry_data(train_file_path)
            test_arr=load_np_arry_data(test_file_path)
